...
//		BoardController.getBoardByno(30);// 없는 게시물
//
//		System.out.println();


//        System.out.println("********** [3] 게시물 제목이 포함된 모든 게시글들 검색 ******************");
//        BoardController.boardSelectBySubject("수");
//
//        System.out.println();
...
//        BoardController.boardUpdate(new BoardDTO(2, "myBatis수업"));//글번호 있는 게시물 수정
//
//        System.out.println();
//        System.out.println("2. 게시물이 존재하지 않는 경우 실행결과 ");
//        BoardController.boardUpdate(new BoardDTO(50, "myBatis수업"));//글번호 없는 게시물 수정
...
//        BoardController.boardDelete(15);
    }
}
